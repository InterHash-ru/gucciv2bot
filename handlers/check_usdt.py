							...
							for wallet in all_wallets:
								if wallet['address'] == address_from and wallet['outgoing_transactions'] == 1:
									...
									if transfer_amount > 0:
										...
										# print(Fore.GREEN + "ADDRESS FROM - " + Style.RESET_ALL + Fore.CYAN + str(address_from) + Style.RESET_ALL + Fore.GREEN + " | ADDRESS TO -" + Style.RESET_ALL + Fore.CYAN + address_to + Style.RESET_ALL + Fore.GREEN +" | SUM: " + str(round(transfer_amount, 2)) + "$ | Balance: ≈ " + str('{0:,}'.format(int(balance_wallet)).replace(',', '.')) + "$" + Style.RESET_ALL)
									...
									if transfer_amount > 0:
										...
										# print(Fore.RED + "ADDRESS TO - " + Style.RESET_ALL +  Fore.CYAN + str(address_to) + Style.RESET_ALL + Fore.RED + " | ADDRESS  FROM -" + Style.RESET_ALL + Fore.CYAN + address_from + Style.RESET_ALL + Fore.RED + " | SUM: " + str(round(transfer_amount, 2)) + "$ | Balance: ≈ " + str('{0:,}'.format(int(balance_wallet)).replace(',', '.')) + "$" + Style.RESET_ALL)
								else:
									pass
